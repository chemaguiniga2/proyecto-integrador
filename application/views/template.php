...
?>
        ...
        <aside class="app-sidebar app-sidebar2">
          ...
          <ul class="side-menu">
            ...
            <li class="slide">
              <a class="side-menu__item" href="<?php echo base_url() . 'billing/plansAdministration' ?>"><i class="side-menu__icon fa fa-cube"></i><span class="side-menu__label">Plans Administration</span></a>
            </li>
            <li class="slide">
              <a class="side-menu__item" href="<?php echo base_url() . 'billing/usersAdministration' ?>"><i class="side-menu__icon fa fa-cube"></i><span class="side-menu__label">Users Administration</span></a>
            </li>
<!-- 			<li class="slide">  -->
							...
							<!-- MESSAGE-BOX -->
									<div class="dropdown text-center selector profile-1">
										...
										<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
											...
											<a class="dropdown-item" href="<?php echo base_url() . 'billing/accountBilling' ?>">
												<i class="dropdown-icon mdi mdi-wallet-membership"></i> Account Billing
											</a>
