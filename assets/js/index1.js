$(function () {
	...
	gradientStroke1.addColorStop(0, 'rgb(42, 239, 218)');
	...
	gradientStroke1.addColorStop(0, 'rgb(42, 239, 218, 0.2)');
    var myChart = new Chart( myCanvas, {
        type: 'line',
        data: {
	...
	var myCanvasContext = myCanvas.getContext("2d");
	var gradientStroke1 = myCanvasContext.createLinearGradient(0, 0, 0, 200);
	gradientStroke1.addColorStop(0, 'rgb(255, 187, 87,0.2)');

	var gradientStroke2 = myCanvasContext.createLinearGradient(0, 0, 0, 190);
	gradientStroke2.addColorStop(0, 'rgb(42, 239, 218,0.2)');
	var myChart = new Chart( myCanvas, {
		type: 'line',
		data : {
	...
	Highcharts.setOptions({
			colors: ['rgb(16, 220, 198 ,0.9)', 'rgb(255, 235, 59, 0.9)', 'rgb(249, 90, 90, 0.9)', 'rgb(23, 228, 12,0.9)','rgb(245, 164, 45,0.9)']
	})
   ...
   /* Hight chart*/
	...
	exporting: { enabled: false },
		...
		colors: ['rgb(42, 239, 218,0.4)', 'rgb(255, 187, 87,0.4)', 'rgba(32, 247, 21,0.4)', 'rgba(255, 235, 59,0.4)', 'rgba(245, 51, 79,0.3)', 'rgba(255, 187, 87,0.4)', 'rgba(32, 247, 21,0.4)', 'rgba(255,255,255,0.4)'],
		series: [{
			type: 'column',
			colorByPoint: true,
