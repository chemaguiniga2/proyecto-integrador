$(function(e) {
	...
	gradientStroke1.addColorStop(0, 'rgba(42, 239, 218, 0.9)');

	var gradientStroke2 = myCanvasContext.createLinearGradient(0, 0, 0, 360);
	gradientStroke2.addColorStop(0, 'rgba(255, 187, 87, 0.9)');
	...
	gradientStroke1.addColorStop(0, 'rgba(42, 239, 218, 0.3)');
	
	var gradientStroke2 = myCanvasContext.createLinearGradient(0, 0, 0, 280);
	gradientStroke2.addColorStop(0, 'rgb(251, 188, 96 ,0.3)');
    ...
    var myChart = new Chart( myCanvas, {
		...
		data: {
            ...
            datasets: [ {
				...
				backgroundColor: gradientStroke1,
				borderColor: '#2aefda',
				pointBackgroundColor:'#2aefda',
				pointHoverBackgroundColor:gradientStroke1,
				pointBorderColor :'#2aefda',
				...
				backgroundColor: gradientStroke2,
				borderColor: '#ffbb57 ',
				pointBackgroundColor:'#ffbb57',
				pointHoverBackgroundColor:gradientStroke2,
				pointBorderColor :'#ffbb57 ',
