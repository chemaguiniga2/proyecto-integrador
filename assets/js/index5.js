(function($) {
	...
	gradientStroke2.addColorStop(0, 'rgba(251, 188, 96,0.9)');
    ...
    var updatingChart = $(".updating-chart1").peity("line", { width: "100%",height:160 })
	...
	gradientStroke1.addColorStop(0, 'rgba(42, 239, 218,0.2)');
	var myChart = new Chart(ctx, {
		type: 'line',
		data: {
