$(function(e) {
	...
	gradientStroke2.addColorStop(0, 'rgb(251, 188, 96,0.9)');
    ...
    var myChart = new Chart( ctx, {
        ...
        data: {
            ...
            datasets: [ {
                ...
                label: 'Market value',
                backgroundColor: 'rgb(42, 239, 218,0.2)',
				borderColor: '#2aefda ',
				borderWidth: 2,
				pointStyle: 'circle',
				pointRadius: 0,
    ...
    var myChart = new Chart( ctx, {
        ...
        data: {
            ...
            datasets: [ {
                ...
                label: 'Market value',
                backgroundColor: 'rgb(251, 188, 96,0.2)',
				borderColor: '#fbbc60 ',
				borderWidth: 2,
				pointStyle: 'circle',
				pointRadius: 0,
    ...
    var myChart = new Chart( ctx, {
        ...
        data: {
            ...
            datasets: [ {
                ...
                label: 'Market value',
                backgroundColor: 'rgba(23, 228, 12, 0.2)',
                borderColor: 'rgba(23, 228, 12)',
				borderWidth: 2,
				pointStyle: 'circle',
				pointRadius: 0,
				pointBorderColor: 'transparent',
				pointBackgroundColor: 'rgba(23, 228, 12)',
			}]
		},
		options: {
			responsive: true,
