  ...
  'use strict';
	...
	Highcharts.chart('highchart3', {
		...
		series: [{
			...
			colors: ['rgb(42, 239, 218,0.7)  ', 'rgb(251, 188, 96,0.8)', '#f1c40f', '#24CBE5', '#64E572', '#FF9655', '#FFF263', '#6AF9C4']
		}]
	});
	...
	Highcharts.chart('highchart4', {
		...
		series: [{
			...
			colors: ['rgb(42, 239, 218,0.7)', 'rgb(251, 188, 96,0.8)', '#f1c40f']
		}]
	});
	...
	Highcharts.chart('highchart5', {
		...
		colors: ['#f1c40f', '#24CBE5', '#64E572' , 'rgb(42, 239, 218,0.7)  ', 'rgb(251, 188, 96,0.8)' ],
		credits: {
			enabled: false
		},
		series: [{
	...
	colors: ['rgb(42, 239, 218,0.7)  ', 'rgb(251, 188, 96,0.8)', '#f1c40f', '#24CBE5', '#64E572', '#FF9655', '#f1c40f', '#6AF9C4'],
    series: [{
        type: 'column',
        colorByPoint: true,
